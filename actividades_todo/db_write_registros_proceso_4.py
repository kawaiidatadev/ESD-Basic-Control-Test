...
from actividades_todo.estatus_proceso4 import manejo_de_estatus4_terminda
from actividades_todo.crear_pdf_proceso4 import pdf_proceso4
...
def db_proceso_4_registro(registros):
    ...
    try:
        ...
        manejo_de_estatus4_terminda()
        pdf_proceso4(registros)
