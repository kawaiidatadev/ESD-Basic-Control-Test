...
def iniciar_p2(ventana_procedimiento_actividad, global_estatus_titulo):
    ...
    if respuesta:  # Si el usuario elige 'Sí'
        ...
        frame_registros = tk.Frame(proceso_2)
        ...
        btn_nuevo_registro = tk.Button(proceso_2, text="Nuevo registro de medición", command=nuevo_registro, font=("Arial", 12, "bold"), bg="green", fg="white", height=2, width=25)
        ...
        btn_confirmar = tk.Button(proceso_2, text="Confirmar registros", command=confirmar_registros, font=("Arial", 12, "bold"), bg="orange", fg="white", height=2, width=25)
